...
import { GymsSection } from "@/components/user/gyms";
import {
  ArrowUpCircle,
  Check,
  ChevronLeft,
...
const UserDashboard = () => {
    ...
    <div className="fade-up max-w-[1400px]">
      ...
      <div className="top-sys mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3">
        ...
        <div className="card relative flex flex-col overflow-hidden rounded-[40px] border border-white/[0.06] bg-[#111] p-7 lg:min-h-[372px] lg:px-5 lg:py-4">
          ...
          {/* Streak HUD */}
          <div className="relative mt-2 flex items-center justify-between rounded-[20px] border border-orange-600/25 bg-[linear-gradient(135deg,rgba(234,88,12,0.12),rgba(250,204,21,0.04))] p-4 px-5 shadow-[0_8px_32px_rgba(234,88,12,0.1)] lg:mt-1.5 lg:p-2.5 lg:px-3.5">
            <div className="flex items-center gap-3.5 lg:gap-3">
              <div className="animate-pulse-glow flex h-12 w-12 items-center justify-center rounded-[14px] border border-orange-600/25 bg-orange-600/10 lg:h-10 lg:w-10">
  ...
  const renderContent = () => {
    switch (activeSection) {
      case "gyms":
        return <GymsSection onSwitchToCheckIn={() => setActiveSection("checkin")} />;
      case "routines":
