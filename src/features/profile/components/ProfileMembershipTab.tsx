    ...
    <div className="rounded-[18px] border border-orange-500/20 bg-gradient-to-br from-orange-500/10 to-transparent p-4 sm:p-7 shadow-sm">
      ...
      <div className="mt-3 grid grid-cols-4 gap-1.5 sm:mt-6 sm:gap-3">
        {[
          ...
          >
            <p className="text-[8px] font-black uppercase tracking-[0.14em] text-gray-500 sm:text-[9px]">
              {item.label}
            </p>
            <p className="mt-0.5 text-[11px] font-black text-white sm:mt-1 sm:text-lg">{item.value}</p>
          </div>
        ))}
      </div>

      <div className="mt-4 flex flex-col gap-2 sm:mt-5 sm:flex-row sm:flex-wrap" role="group" aria-label="Membership actions">
        <button
          type="button"
          onClick={onViewDetails}
          aria-label="View membership details"
          className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.14em] text-white shadow-lg shadow-orange-500/20 transition-all hover:-translate-y-0.5 hover:shadow-orange-500/35 sm:w-auto"
        >
          Membership Details
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center rounded-full border table-border user-surface-soft px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.14em] text-slate-200 transition-colors hover:bg-white/10 hover:text-white sm:w-auto"
        >
          View Plans
        </button>
      </div>
  ...
  return (
    <div className="mt-4 grid grid-cols-3 gap-2 sm:mt-5 sm:gap-3">
      <div className="rounded-xl border table-border user-surface-soft p-2.5 shadow-sm transition duration-200 hover:brightness-110 sm:rounded-[18px] sm:px-5 sm:py-4">
        ...
        <p className="mt-0.5 truncate text-[11px] font-black text-white sm:mt-1 sm:text-[15px]">
  ...
  return (
    <div className="flex flex-col items-center rounded-[18px] border table-border user-surface-soft p-10 text-center shadow-sm">
      ...
      <button
        type="button"
        onClick={onViewPlans}
        className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-3 text-[11px] font-bold uppercase tracking-[0.14em] text-white shadow-lg shadow-orange-500/20 transition-all hover:-translate-y-0.5 hover:shadow-orange-500/35 sm:w-auto"
      >
        View Plans
