...
import { ADMIN_DASHBOARD_ROUTE } from "@/features/auth/auth-routing";
...
const AdminLoginPortal = () => {
  ...
  return (
    <main
      className="relative flex h-screen items-center justify-center overflow-hidden px-4 py-4 text-foreground sm:px-6"
    ...
    >
      ...
      {/* Deep orange top bleed — sits on top of the grid */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% -10%, rgba(234,88,12,0.45) 0%, transparent 60%)",
        }}
      />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`admin-password-input w-full rounded-full border bg-input py-3 pl-11 pr-14 text-sm font-medium text-foreground outline-none transition placeholder:text-muted-foreground/60 focus:border-orange-500/60 focus:shadow-[0_0_0_3px_rgba(249,115,22,0.12)] ${
      ...
      <style>{`
        .admin-password-input::-ms-reveal,
        .admin-password-input::-ms-clear {
          display: none;
        }
      `}</style>
    </main>
