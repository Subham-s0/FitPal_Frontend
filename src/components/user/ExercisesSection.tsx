...
import { AddCustomExerciseModal } from "@/components/user/AddCustomExerciseModal";
...
const ExercisesSection = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-6rem)] w-full overflow-hidden font-sans text-white">
      ...
      <aside className="relative z-10 flex w-80 shrink-0 flex-col border-l border-white/5 bg-[#0a0a0a]/95 backdrop-blur-sm">
